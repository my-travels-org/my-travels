        ...
        <h2 className={styles.heading}>Terminos y Condiciones</h2>
            <div className={styles.textContainer}>
                <h3 className={styles.title} >Bienvenido/a a MyTravels, la comunidad en línea dedicada al turismo en México.</h3>
                    ...
                    te pedimos que leas atentamente estos Términos y Condiciones de Uso, ya que constituyen un acuerdo legal entre tú (en adelante, "Usuario") y MyTravels.</h3>
                ...
                así como con cualquier política adicional que pueda publicarse en la plataforma.</p>
                ...
                La información proporcionada debe ser precisa y actualizada. Eres responsable de la seguridad de tu cuenta y contraseña.</p>
                ...
                la manipulación o cualquier acción que pueda afectar la integridad de la plataforma o la experiencia de otros usuarios.</p>
                ...
                los derechos necesarios para hacerlo y liberas a MyTravels de cualquier responsabilidad.</p>
                ...
                Al utilizar la plataforma, aceptas el procesamiento de tus datos según lo establecido en dicha política.</p>
                ...
                para utilizar, modificar y mostrar dicho contenido en la plataforma.</p>
                ...
                considere necesario para proteger la integridad de la plataforma.</p>
                ...
                La plataforma se proporciona "tal cual" y "según disponibilidad".</p>
                ...
                Los cambios entrarán en vigencia una vez publicados en la plataforma.</p>
                ...
                <p className={styles.text}>Estos Términos y Condiciones se rigen por las leyes de México. Cualquier disputa se resolverá en los 
                    tribunales de Guadalajara de acuerdo con la legislación mexicana aplicable.</p>
                ...
                Gracias por ser parte de MyTravels. ¡Esperamos que tengas experiencias de viaje inolvidables en México!</p>
            </div>
      </section>
    )
  }
